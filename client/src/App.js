...
import AddInvestor from './pages/investors/AddInvestor'; // Import the new component
import AddStartup from './pages/startups/AddStartup'; // Import the AddStartup component
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path='/add-investor' element={<AddInvestor />} /> {/* Add new route for adding investors */}
          <Route exact path='/add-startup' element={<AddStartup />} /> {/* Add new route for adding startups */}
          </>
          )}
          ...
          <Route exact path="/startup/:id" element={<StartupProfile />} /> {/* Add this new route */}
